...
svy = load('Oilsvymeans_baseline_noinventory.txt');
...
for i = 1:N
    tic;
    yb  = sparse(ybetas_noinventory(i,:));
...
opu_baseline_noinventory(:,:) = sqrt(ut(:,1,:));

save opu_baseline_noinventory opu_baseline_noinventory
