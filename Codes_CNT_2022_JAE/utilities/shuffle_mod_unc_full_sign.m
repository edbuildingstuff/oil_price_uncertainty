...
if Atilde(1,1)>0 && Atilde(2,1)>0 && Atilde(3,1)<0 && Atilde(4,1)>0 
            s1is=100;
elseif Atilde(1,2)>0 && Atilde(2,2)>0 && Atilde(3,2)<0 && Atilde(4,2)>0 
            s2is=100;
elseif Atilde(1,3)>0 && Atilde(2,3)>0 && Atilde(3,3)<0 && Atilde(4,3)>0 
            s3is=100;
elseif Atilde(1,4)>0 && Atilde(2,4)>0 && Atilde(3,4)<0 && Atilde(4,4)>0 
            s4is=100;
elseif Atilde(1,5)>0 && Atilde(2,5)>0 && Atilde(3,5)<0 && Atilde(4,5)>0 
            s5is=100;
end
...
% 4. Uncertainty demand shock: -,-,+,+,+ 
if  Atilde(2,1)<0 && Atilde(3,1)>0 && Atilde(4,1)>0 && Atilde(5,1)>0 
           s1is=1000;
elseif  Atilde(2,2)<0 && Atilde(3,2)>0 && Atilde(4,2)>0 && Atilde(5,2)>0  
           s2is=1000;
elseif  Atilde(2,3)<0 && Atilde(3,3)>0 && Atilde(4,3)>0 && Atilde(5,3)>0   
           s3is=1000;
elseif  Atilde(2,4)<0 && Atilde(3,4)>0 && Atilde(4,4)>0 && Atilde(5,4)>0   
           s4is=1000;
elseif  Atilde(2,5)<0 && Atilde(3,5)>0 && Atilde(4,5)>0 && Atilde(5,5)>0 
           s5is=1000;
end
