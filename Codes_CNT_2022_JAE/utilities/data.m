...
% sample length
if sample == 0
    time=(1973+2/12:1/12:2018+6/12)'; % 1973M2-2018M6 
elseif sample == 1
    time=(1973+2/12:1/12:2018+6/12)'; % 1973M2-2008M8
else
...
y=[time dif(log(worldoilproduction)) rea_new(2:end,1) log(rpoil(2:end)) dif(stocks)];
...
% time=(1973+2/12+24/12:1/12:2018+6/12)'; % new sample
